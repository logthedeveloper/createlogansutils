package com.logthedeveloper.createmorecakes.loot;
    ...
    protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        if (context.getRandom().nextFloat() < 0.1f) { // 10% chance
            generatedLoot.add(new ItemStack(
                    BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(CreateMoreCakes.MODID, "music_disc_barkfart"))
            ));
        }
